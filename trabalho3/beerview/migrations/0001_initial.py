    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='beers/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.CharField(choices=[('BO', 'Bock'), ('BA', 'Brown Ale'), ('DA', 'Dark Ale'), ('HY', 'Hybrid Beer'), ('IP', 'India Pale Ale'), ('PA', 'Pale Ale'), ('PL', 'Pale Lager'), ('PO', 'Porter'), ('ES', 'Specialty Beer'), ('ST', 'Stout'), ('SA', 'Strong Ale'), ('WH', 'Wheat Beer'), ('WI', 'Wild/Sour Beer')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='breweries/')),
